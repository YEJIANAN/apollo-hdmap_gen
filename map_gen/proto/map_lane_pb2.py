...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=b'\n\x0emap_lane.proto\x12\x05hdmap\x1a\x0cmap_id.proto\x1a\x12map_geometry.proto\"\xc4\x01\n\x10LaneBoundaryType\x12\t\n\x01s\x18\x01 \x01(\x01\x12+\n\x05types\x18\x02 \x03(\x0e\x32\x1c.hdmap.LaneBoundaryType.Type\"x\n\x04Type\x12\x0b\n\x07UNKNOWN\x10\x00\x12\x11\n\rDOTTED_YELLOW\x10\x01\x12\x10\n\x0c\x44OTTED_WHITE\x10\x02\x12\x10\n\x0cSOLID_YELLOW\x10\x03\x12\x0f\n\x0bSOLID_WHITE\x10\x04\x12\x11\n\rDOUBLE_YELLOW\x10\x05\x12\x08\n\x04\x43URB\x10\x06\"|\n\x0cLaneBoundary\x12\x1b\n\x05\x63urve\x18\x01 \x01(\x0b\x32\x0c.hdmap.Curve\x12\x0e\n\x06length\x18\x02 \x01(\x01\x12\x0f\n\x07virtual\x18\x03 \x01(\x08\x12.\n\rboundary_type\x18\x04 \x03(\x0b\x32\x17.hdmap.LaneBoundaryType\"1\n\x15LaneSampleAssociation\x12\t\n\x01s\x18\x01 \x01(\x01\x12\r\n\x05width\x18\x02 \x01(\x01\"\xe2\x08\n\x04Lane\x12\x15\n\x02id\x18\x01 \x01(\x0b\x32\t.hdmap.Id\x12#\n\rcentral_curve\x18\x02 \x01(\x0b\x32\x0c.hdmap.Curve\x12*\n\rleft_boundary\x18\x03 \x01(\x0b\x32\x13.hdmap.LaneBoundary\x12+\n\x0eright_boundary\x18\x04 \x01(\x0b\x32\x13.hdmap.LaneBoundary\x12\x0e\n\x06length\x18\x05 \x01(\x01\x12\x13\n\x0bspeed_limit\x18\x06 \x01(\x01\x12\x1d\n\noverlap_id\x18\x07 \x03(\x0b\x32\t.hdmap.Id\x12!\n\x0epredecessor_id\x18\x08 \x03(\x0b\x32\t.hdmap.Id\x12\x1f\n\x0csuccessor_id\x18\t \x03(\x0b\x32\t.hdmap.Id\x12\x30\n\x1dleft_neighbor_forward_lane_id\x18\n \x03(\x0b\x32\t.hdmap.Id\x12\x31\n\x1eright_neighbor_forward_lane_id\x18\x0b \x03(\x0b\x32\t.hdmap.Id\x12\"\n\x04type\x18\x0c \x01(\x0e\x32\x14.hdmap.Lane.LaneType\x12\"\n\x04turn\x18\r \x01(\x0e\x32\x14.hdmap.Lane.LaneTurn\x12\x30\n\x1dleft_neighbor_reverse_lane_id\x18\x0e \x03(\x0b\x32\t.hdmap.Id\x12\x31\n\x1eright_neighbor_reverse_lane_id\x18\x0f \x03(\x0b\x32\t.hdmap.Id\x12\x1e\n\x0bjunction_id\x18\x10 \x01(\x0b\x32\t.hdmap.Id\x12\x31\n\x0bleft_sample\x18\x11 \x03(\x0b\x32\x1c.hdmap.LaneSampleAssociation\x12\x32\n\x0cright_sample\x18\x12 \x03(\x0b\x32\x1c.hdmap.LaneSampleAssociation\x12,\n\tdirection\x18\x13 \x01(\x0e\x32\x19.hdmap.Lane.LaneDirection\x12\x36\n\x10left_road_sample\x18\x14 \x03(\x0b\x32\x1c.hdmap.LaneSampleAssociation\x12\x37\n\x11right_road_sample\x18\x15 \x03(\x0b\x32\x1c.hdmap.LaneSampleAssociation\x12\'\n\x14self_reverse_lane_id\x18\x16 \x03(\x0b\x32\t.hdmap.Id\"[\n\x08LaneType\x12\x08\n\x04NONE\x10\x01\x12\x10\n\x0c\x43ITY_DRIVING\x10\x02\x12\n\n\x06\x42IKING\x10\x03\x12\x0c\n\x08SIDEWALK\x10\x04\x12\x0b\n\x07PARKING\x10\x05\x12\x0c\n\x08SHOULDER\x10\x06\"B\n\x08LaneTurn\x12\x0b\n\x07NO_TURN\x10\x01\x12\r\n\tLEFT_TURN\x10\x02\x12\x0e\n\nRIGHT_TURN\x10\x03\x12\n\n\x06U_TURN\x10\x04\";\n\rLaneDirection\x12\x0b\n\x07\x46ORWARD\x10\x01\x12\x0c\n\x08\x42\x41\x43KWARD\x10\x02\x12\x0f\n\x0b\x42IDIRECTION\x10\x03'
  ,
...
_LANEBOUNDARYTYPE_TYPE = _descriptor.EnumDescriptor(
  name='Type',
  full_name='hdmap.LaneBoundaryType.Type',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_LANE_LANEDIRECTION = _descriptor.EnumDescriptor(
  name='LaneDirection',
  full_name='hdmap.Lane.LaneDirection',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_LANEBOUNDARYTYPE = _descriptor.Descriptor(
  ...
  full_name='hdmap.LaneBoundaryType',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='s', full_name='hdmap.LaneBoundaryType.s', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='types', full_name='hdmap.LaneBoundaryType.types', index=1,
...
_LANEBOUNDARY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='curve', full_name='hdmap.LaneBoundary.curve', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='length', full_name='hdmap.LaneBoundary.length', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='virtual', full_name='hdmap.LaneBoundary.virtual', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='boundary_type', full_name='hdmap.LaneBoundary.boundary_type', index=3,
...
_LANESAMPLEASSOCIATION = _descriptor.Descriptor(
  ...
  full_name='hdmap.LaneSampleAssociation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='s', full_name='hdmap.LaneSampleAssociation.s', index=0,
      number=1, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='width', full_name='hdmap.LaneSampleAssociation.width', index=1,
      number=2, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LANE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='hdmap.Lane.id', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='central_curve', full_name='hdmap.Lane.central_curve', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='left_boundary', full_name='hdmap.Lane.left_boundary', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='right_boundary', full_name='hdmap.Lane.right_boundary', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='length', full_name='hdmap.Lane.length', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='speed_limit', full_name='hdmap.Lane.speed_limit', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='overlap_id', full_name='hdmap.Lane.overlap_id', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='predecessor_id', full_name='hdmap.Lane.predecessor_id', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='successor_id', full_name='hdmap.Lane.successor_id', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='left_neighbor_forward_lane_id', full_name='hdmap.Lane.left_neighbor_forward_lane_id', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='right_neighbor_forward_lane_id', full_name='hdmap.Lane.right_neighbor_forward_lane_id', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='type', full_name='hdmap.Lane.type', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='turn', full_name='hdmap.Lane.turn', index=12,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='left_neighbor_reverse_lane_id', full_name='hdmap.Lane.left_neighbor_reverse_lane_id', index=13,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='right_neighbor_reverse_lane_id', full_name='hdmap.Lane.right_neighbor_reverse_lane_id', index=14,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='junction_id', full_name='hdmap.Lane.junction_id', index=15,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='left_sample', full_name='hdmap.Lane.left_sample', index=16,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='right_sample', full_name='hdmap.Lane.right_sample', index=17,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='direction', full_name='hdmap.Lane.direction', index=18,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='left_road_sample', full_name='hdmap.Lane.left_road_sample', index=19,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='right_road_sample', full_name='hdmap.Lane.right_road_sample', index=20,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='self_reverse_lane_id', full_name='hdmap.Lane.self_reverse_lane_id', index=21,
...
LaneBoundaryType = _reflection.GeneratedProtocolMessageType('LaneBoundaryType', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:hdmap.LaneBoundaryType)
  })
...
LaneBoundary = _reflection.GeneratedProtocolMessageType('LaneBoundary', (_message.Message,), {
  ...
  '__module__' : 'map_lane_pb2'
  # @@protoc_insertion_point(class_scope:hdmap.LaneBoundary)
  })
...
LaneSampleAssociation = _reflection.GeneratedProtocolMessageType('LaneSampleAssociation', (_message.Message,), {
  ...
  '__module__' : 'map_lane_pb2'
  # @@protoc_insertion_point(class_scope:hdmap.LaneSampleAssociation)
  })
...
Lane = _reflection.GeneratedProtocolMessageType('Lane', (_message.Message,), {
  'DESCRIPTOR' : _LANE,
  '__module__' : 'map_lane_pb2'
  # @@protoc_insertion_point(class_scope:hdmap.Lane)
  })
