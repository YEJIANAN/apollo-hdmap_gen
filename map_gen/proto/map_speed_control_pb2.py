...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=b'\n\x17map_speed_control.proto\x12\x05hdmap\x1a\x12map_geometry.proto\"R\n\x0cSpeedControl\x12\x0c\n\x04name\x18\x01 \x01(\t\x12\x1f\n\x07polygon\x18\x02 \x01(\x0b\x32\x0e.hdmap.Polygon\x12\x13\n\x0bspeed_limit\x18\x03 \x01(\x01\";\n\rSpeedControls\x12*\n\rspeed_control\x18\x01 \x03(\x0b\x32\x13.hdmap.SpeedControl'
  ,
...
_SPEEDCONTROL = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='hdmap.SpeedControl.name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='polygon', full_name='hdmap.SpeedControl.polygon', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='speed_limit', full_name='hdmap.SpeedControl.speed_limit', index=2,
...
_SPEEDCONTROLS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='speed_control', full_name='hdmap.SpeedControls.speed_control', index=0,
...
SpeedControl = _reflection.GeneratedProtocolMessageType('SpeedControl', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:hdmap.SpeedControl)
  })
...
SpeedControls = _reflection.GeneratedProtocolMessageType('SpeedControls', (_message.Message,), {
  ...
  '__module__' : 'map_speed_control_pb2'
  # @@protoc_insertion_point(class_scope:hdmap.SpeedControls)
  })
