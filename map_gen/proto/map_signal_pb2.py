...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=b'\n\x10map_signal.proto\x12\x05hdmap\x1a\x0egeometry.proto\x1a\x12map_geometry.proto\x1a\x0cmap_id.proto\"\x8c\x02\n\tSubsignal\x12\x15\n\x02id\x18\x01 \x01(\x0b\x32\t.hdmap.Id\x12#\n\x04type\x18\x02 \x01(\x0e\x32\x15.hdmap.Subsignal.Type\x12\"\n\x08location\x18\x03 \x01(\x0b\x32\x10.common.PointENU\"\x9e\x01\n\x04Type\x12\x0b\n\x07UNKNOWN\x10\x01\x12\n\n\x06\x43IRCLE\x10\x02\x12\x0e\n\nARROW_LEFT\x10\x03\x12\x11\n\rARROW_FORWARD\x10\x04\x12\x0f\n\x0b\x41RROW_RIGHT\x10\x05\x12\x1a\n\x16\x41RROW_LEFT_AND_FORWARD\x10\x06\x12\x1b\n\x17\x41RROW_RIGHT_AND_FORWARD\x10\x07\x12\x10\n\x0c\x41RROW_U_TURN\x10\x08\"Z\n\x08SignInfo\x12\"\n\x04type\x18\x01 \x01(\x0e\x32\x14.hdmap.SignInfo.Type\"*\n\x04Type\x12\x08\n\x04None\x10\x00\x12\x18\n\x14NO_RIGHT_TURN_ON_RED\x10\x01\"\xe1\x02\n\x06Signal\x12\x15\n\x02id\x18\x01 \x01(\x0b\x32\t.hdmap.Id\x12 \n\x08\x62oundary\x18\x02 \x01(\x0b\x32\x0e.hdmap.Polygon\x12#\n\tsubsignal\x18\x03 \x03(\x0b\x32\x10.hdmap.Subsignal\x12\x1d\n\noverlap_id\x18\x04 \x03(\x0b\x32\t.hdmap.Id\x12 \n\x04type\x18\x05 \x01(\x0e\x32\x12.hdmap.Signal.Type\x12\x1f\n\tstop_line\x18\x06 \x03(\x0b\x32\x0c.hdmap.Curve\x12\"\n\tsign_info\x18\x07 \x03(\x0b\x32\x0f.hdmap.SignInfo\"s\n\x04Type\x12\x0b\n\x07UNKNOWN\x10\x01\x12\x14\n\x10MIX_2_HORIZONTAL\x10\x02\x12\x12\n\x0eMIX_2_VERTICAL\x10\x03\x12\x14\n\x10MIX_3_HORIZONTAL\x10\x04\x12\x12\n\x0eMIX_3_VERTICAL\x10\x05\x12\n\n\x06SINGLE\x10\x06'
  ,
...
_SUBSIGNAL_TYPE = _descriptor.EnumDescriptor(
  name='Type',
  full_name='hdmap.Subsignal.Type',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_SUBSIGNAL = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='hdmap.Subsignal.id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='type', full_name='hdmap.Subsignal.type', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='location', full_name='hdmap.Subsignal.location', index=2,
...
_SIGNINFO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='type', full_name='hdmap.SignInfo.type', index=0,
...
_SIGNAL = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='hdmap.Signal.id', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='boundary', full_name='hdmap.Signal.boundary', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='subsignal', full_name='hdmap.Signal.subsignal', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='overlap_id', full_name='hdmap.Signal.overlap_id', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='type', full_name='hdmap.Signal.type', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='stop_line', full_name='hdmap.Signal.stop_line', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='sign_info', full_name='hdmap.Signal.sign_info', index=6,
...
Subsignal = _reflection.GeneratedProtocolMessageType('Subsignal', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:hdmap.Subsignal)
  })
...
SignInfo = _reflection.GeneratedProtocolMessageType('SignInfo', (_message.Message,), {
  ...
  '__module__' : 'map_signal_pb2'
  # @@protoc_insertion_point(class_scope:hdmap.SignInfo)
  })
...
Signal = _reflection.GeneratedProtocolMessageType('Signal', (_message.Message,), {
  'DESCRIPTOR' : _SIGNAL,
  '__module__' : 'map_signal_pb2'
  # @@protoc_insertion_point(class_scope:hdmap.Signal)
  })
